...
const customEmail = (exports.customEmail = (
  ...
  switch (type) {
    ...
    case 2:
      ...
      mailOptions.text =
        `Your MangaDB account ${user} was deleted.\n` +
        `If you did not request this change, then please change your password and check account integrity.`;
      break;
    case 3:
      ...
      mailOptions.text =
        `The admin ${user} has requested this action.\n` +
        `If you did not request this change, then please change your password and check account integrity.`;
      break;
    case 4:
      ...
      mailOptions.text =
        `All your manga records for MangaDB account ${user} were deleted.\n` +
        `If you did not request this change, then please change your password and check account integrity.`;
      break;
    case 5:
    ...
    case 6:
      ...
      mailOptions.text =
        `A reset token was requested for ${email}. It will be valid only for 5 minutes.\n` +
